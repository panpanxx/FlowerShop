...
<%@ page language="java" import="java.util.*,dao.umDao" pageEncoding="UTF-8"%>
<%
...
--%>
<div id="msg"><h1><%=msg%>,5秒后返回首页,如浏览器无反应,<a href="um.jsp">请点击</a></h1></div>
<script type="text/javascript">
	var count=4;
	window.setInterval(function(){
		...
		div_msg.innerHTML="<h1><%=msg%>,"+count+"秒后返回首页,如浏览器无反应,<a href='um.jsp'>请点击</a></h1>"
		count--;
	}, 1000);
</script>
